...
import { taskCreateContext } from '../taskCreate/TaskCreate'
import { taskUpdateContext } from '../taskUpdate/TaskUpdate'
...
function TaskForm(props) {
    ...
    // // // // 2nd way ==> get data from another component  ==> by using useContext Hooks
    // const infoCreateContext = useContext(taskCreateContext)
    // const infoUpdateContext = useContext(taskUpdateContext)
    // let taskField, isTaskUpdate
    // if (infoCreateContext != undefined) {
    //     taskField = infoCreateContext.taskField
    //     isTaskUpdate = infoCreateContext.isTaskUpdate
    // } else if (infoUpdateContext != undefined) {
    //     taskField = infoUpdateContext.taskField
    //     isTaskUpdate = infoUpdateContext.isTaskUpdate
    // }
